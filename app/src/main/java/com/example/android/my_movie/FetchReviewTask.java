...
public class FetchReviewTask extends AsyncTask<String,Void, String[]>
{
    ...
    private String[] getReviewsFromJson(String MovieJsonStr)
            throws JSONException
    {
        ...
        for (int i=0;i<MovieArray.length();i++)
        {
            ...
            review=MovieInfo.getString("content");
            author=MovieInfo.getString("author");
            resultStrs[i]=author+"\n"+review;
            MovieFragment.Reviews.add(resultStrs[i]);
        }
